...
::: {.alert .alert-warning}
**Exercise**: Discuss in groups or the person next to you:
...
3. describe what a confidence interval is and how it can be used.

Write your answers down in your R Markdown document.
:::
